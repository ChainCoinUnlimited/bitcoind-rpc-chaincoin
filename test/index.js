...
describe('RpcClient', function() {
  ...
  it('should callback with error if invalid json', function(done) {
    ...
    client.getDifficulty(function(error, parsedBuf) {
      requestStub.restore();
      should.exist(error);
      error.message.should.equal('Chaincoin JSON-RPC: Error Parsing JSON: Unexpected token o');
      done();
    });
  ...
  it('should callback with error if blank response', function(done) {
    ...
    client.getDifficulty(function(error, parsedBuf) {
      requestStub.restore();
      should.exist(error);
      error.message.should.equal('Chaincoin JSON-RPC: Error Parsing JSON: Unexpected end of input');
      done();
    });
